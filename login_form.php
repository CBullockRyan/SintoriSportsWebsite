...
<body>
	...
	<form action="login_form.php" method="post">
		<p>Staff ID: <input class="form-control" type="text" name="staffID" maxlength="20" value='<?php echo $staffID ?>' /></p>
		<p>Password: <input class="form-control" type="password" name="staffPass" maxlength="40" /></p>
