...
<head>
	<title>Edit Content for Membership Page</title>
...
<body>
    ...
    $row = mysqli_fetch_array($r);
        ...
        $content = mysqli_real_escape_string($dbc, trim($content));
				...
				//insert data
				$q1 = "UPDATE content SET title = '$title', content='$content' WHERE contentID=5 LIMIT 1";
	...
	<h1>Edit Content for Membership page</h1>
	<!-- form to edit content -->
	<form action="content_membership.php" method="post" id="membership">
		<p>Title of Page: <input class='col-3 form-control' type="text" name="title"  value="<?php echo $title ?>" /></p>
		<p>Description: </p>
    <p><textarea class='col-8 form-control' name="content" id = "editor" form="membership" rows="4" cols="40" ><?php echo $content ?></textarea></p>
