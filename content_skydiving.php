...
Date: April 29, 2018
Description: edit content for indoor skydiving
************************************************-->
<?php
...
<head>
	<title>Edit Content for Indoor Skydiving</title>
...
<body>
    ...
    //query to get data for skydiving
    ...
    $row = mysqli_fetch_array($r);
        ...
        $content = mysqli_real_escape_string($dbc, trim($content));
				...
				//insert data
				$q1 = "UPDATE content SET title = '$title', content='$content' WHERE contentID=4 LIMIT 1";
	...
	<form action="content_skydiving.php" method="post" id="skydiving">
