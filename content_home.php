...
Date: April 29, 2018
Description: edit content for home page
************************************************-->
<?php
...
<head>
	<title>Edit Content for the Home Page</title>
...
<body>
    ...
    $row = mysqli_fetch_array($r);
        ...
        $content = mysqli_real_escape_string($dbc, trim($content));
				...
				//insert data
				$q1 = "UPDATE content SET title = '$title', content='$content' WHERE contentID=6 LIMIT 1";
	...
	<form action="content_home.php" method="post" id="home">
		...
		<p>Description: </p>
    <p><textarea class='col-8 form-control' name="content" id = "editor" form="home" rows="4" cols="40" ><?php echo $content ?></textarea></p>
